...
public class PowerControl implements LandRaidControl {
  ...
  public boolean isRaidable(Faction faction) {
    return FactionsPlugin.getInstance().conf().factions().landRaidControl().power()
        .isRaidability() && !faction.isPeaceful() && faction.getLandRounded() >= faction.getPowerRounded();
  }
  ...
  public void onDeath(Player player) {
    ...
    if (faction.isWarZone()) {
      ...
      powerLossEvent.setCancelled(true);
        ...
        .isPeacefulMembersDisablePowerLoss() && fplayer.hasFaction() && fplayer.getFaction().isPeaceful()) {
