...
public class PermissionsMapTypeAdapter implements
  JsonDeserializer<Map<Permissible, Map<PermissibleAction, Boolean>>> {

  @Override
  public Map<Permissible, Map<PermissibleAction, Boolean>> deserialize(JsonElement json, Type type,
    ...
    try {
      ...
      FactionsPlugin.getInstance().getLogger()
        .log(Level.SEVERE, "Error encountered while deserializing a PermissionsMap.", ex);
      return null;
    }
  }
