...
public class DefaultOfflinePermissionsConfig {
  ...
  private DefaultPermissionsConfig.Permissions offlinePermissions =
      new DefaultPermissionsConfig.Permissions();
    ...
    try {
      for (Field field : DefaultPermissionsConfig.Permissions.class.getDeclaredFields()) {
        ...
        if (o instanceof DefaultPermissionsConfig.Permissions.FullPermInfo) {
          DefaultPermissionsConfig.Permissions.FullPermInfo i =
              (DefaultPermissionsConfig.Permissions.FullPermInfo) o;
          i.recruit = null;
          i.normal = null;
          i.moderator = null;
          i.coleader = null;
      ...
      FactionsPlugin.getInstance().getLogger()
          .log(Level.SEVERE, "Failed to update offline permission special states", e);
    }
  }
