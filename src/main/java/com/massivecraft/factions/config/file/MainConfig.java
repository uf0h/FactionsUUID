...
@SuppressWarnings(
    {"FieldCanBeLocal", "FieldMayBeFinal", "InnerClassMayBeStatic", "BooleanMethodIsAlwaysInverted"})
public class MainConfig {
  ...
  public class Commands {
    ...
    public class Fly {
      ...
      @Comment("Trails show below the players foot when flying, faction.fly.trails\n" +
          ...
          "Players can also set which effect to show /f trail effect <particle> only if they have faction" +
          ".fly.trails.<particle>")
  ...
  public class Factions {
    ...
    @Comment("Spawn control.\n" +
        ...
        "https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/entity/CreatureSpawnEvent.SpawnReason" +
        ".html")
      ...
      public class Power {
        ...
        @Comment(
            "If greater than 0, used as a cap for how much power a faction can have\nAdditional power from " +
                "players beyond this acts as a \"buffer\" of sorts")
    ...
    public class Claims {
      ...
      @Comment(
          "If someone is doing a radius claim and the process fails to claim land this many times in a row," +
              " it will exit")
      ...
      @Comment(
          "If true (and allowOverClaim is true, claiming over another faction's land will ignore buffer " +
              "zone settings.")
    ...
    public class Protection {
      ...
      @Comment(
          "Mainly for other plugins/mods that use a fake player to take actions, which shouldn't be subject" +
              " to our protections.")
    ...
    public class Spawning {
      ...
      public Set<EntityType> getPreventInSafezoneExceptions() {
        if (preventSpawningInSafezoneExceptionsType == null) {
          preventSpawningInSafezoneExceptionsType = MiscUtil
              .typeSetFromStringSet(preventSpawningInSafezoneExceptions, MiscUtil.ENTITY_TYPE_FUNCTION);
        }
      ...
      public Set<EntityType> getPreventInWarzoneExceptions() {
        if (preventSpawningInWarzoneExceptionsType == null) {
          preventSpawningInWarzoneExceptionsType = MiscUtil
              .typeSetFromStringSet(preventSpawningInWarzoneExceptions, MiscUtil.ENTITY_TYPE_FUNCTION);
        }
    ...
    public class Other {
      ...
      @Comment(
          "What faction ID to start new players in when they first join the server; default is 0, \"no " +
              "faction\"")
  ...
  public class RestrictWorlds {
    ...
    @Comment(
        "If restrictWorlds is true, this setting determines if the world list below is a whitelist or " +
            "blacklist.\n" +
