...
public class MainConfig {
  ...
  public static class AVeryFriendlyFactionsConfig {
    ...
    @Comment("Debug\n" +
             ...
             "This will spam your console with information that is useful if you know how to read the " +
             "source.\n" +
  ...
  public class Commands {
    ...
    public class Fly {
      ...
      @Comment("Trails show below the players foot when flying, faction.fly.trails\n" +
               ...
               "Players can also set which effect to show /f trail effect <particle> only if they have " +
               "faction.fly.trails.<particle>")
    ...
    public class ListCmd {
      ...
      @Comment("You can only use {pagenumber} and {pagecount} in the header.\nBlank entry results in " +
               "nothing being displayed.")
      private String header =
        "&e&m----------&r&e[ &2Faction List &9{pagenumber}&e/&9{pagecount} &e]&m----------";
      ...
      private String entry =
        "<a>{faction-relation-color}{faction} <i>{online} / {members} online, <a>Land / Power / Maxpower: " +
    ...
    public class Show {
      ...
      @Comment("You can use any variable here, including fancy messages. Color codes and or tags work fine" +
               ".\n" +
               "Lines that aren't defined wont be sent (home not set, faction not peaceful / permanent, dtr" +
               " freeze)\n" +
               "Supports placeholders.\n" +
               "First line can be {header} for default header, or any string (we recommend &m for smooth " +
               "lines ;p)\n" +
  ...
  public class Factions {
    ...
    @Comment("Should we send titles when players enter Factions? Durations are in ticks (20 ticks every " +
             "second)")
    ...
    @Comment("Spawn control.\n" +
             ...
             "https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/entity/CreatureSpawnEvent" +
             ".SpawnReason.html")
    ...
    public class LandRaidControl {
      ...
      public class Power {
        ...
        @Comment("If greater than 0, used as a cap for how much power a faction can have\nAdditional power " +
                 "from players beyond this acts as a \"buffer\" of sorts")
        ...
        public Set<String> getWorldsNoPowerLoss() {
          return worldsNoPowerLoss == null ? Collections.emptySet() :
                 Collections.unmodifiableSet(worldsNoPowerLoss);
        }
    ...
    public class PVP {
      ...
      public Set<String> getWorldsIgnorePvP() {
        return worldsIgnorePvP == null ? Collections.emptySet() :
               Collections.unmodifiableSet(worldsIgnorePvP);
      }
    ...
    public class SpecialCase {
      ...
      public Set<Material> getIgnoreBuildMaterials() {
        if (ignoreBuildMaterialsMat == null) {
          ...
          ignoreBuildMaterials.forEach(m -> ignoreBuildMaterialsMat.add(Material.getMaterial(m)));
    ...
    public class Claims {
      ...
      @Comment("If someone is doing a radius claim and the process fails to claim land this many times in a" +
               " row, it will exit")
      ...
      @Comment("If true (and allowOverClaim is true, claiming over another faction's land will ignore " +
      ...
      public Set<String> getWorldsNoClaiming() {
        return worldsNoClaiming == null ? Collections.emptySet() :
               Collections.unmodifiableSet(worldsNoClaiming);
      }
    ...
    public class Protection {
      ...
      @Comment("Exceptions to consideration for container perms.\n" +
               "For example, putting \"TRAPPED_CHEST\" into here would allow anyone to open trapped chests " +
               "anywhere.")
      ...
      @Comment("Mainly for other plugins/mods that use a fake player to take actions, which shouldn't be " +
               "subject to our protections.")
      ...
      public Set<String> getPermanentFactionMemberDenyCommands() {
        return permanentFactionMemberDenyCommands == null ? Collections.emptySet() :
               Collections.unmodifiableSet(permanentFactionMemberDenyCommands);
      }

      public Set<String> getTerritoryNeutralDenyCommands() {
        return territoryNeutralDenyCommands == null ? Collections.emptySet() :
               Collections.unmodifiableSet(territoryNeutralDenyCommands);
      }

      public Set<String> getTerritoryEnemyDenyCommands() {
        return territoryEnemyDenyCommands == null ? Collections.emptySet() :
               Collections.unmodifiableSet(territoryEnemyDenyCommands);
      }

      public Set<String> getTerritoryAllyDenyCommands() {
        return territoryAllyDenyCommands == null ? Collections.emptySet() :
               Collections.unmodifiableSet(territoryAllyDenyCommands);
      }

      public Set<String> getWarzoneDenyCommands() {
        return warzoneDenyCommands == null ? Collections.emptySet() :
               Collections.unmodifiableSet(warzoneDenyCommands);
      }

      public Set<String> getWildernessDenyCommands() {
        return wildernessDenyCommands == null ? Collections.emptySet() :
               Collections.unmodifiableSet(wildernessDenyCommands);
      }
      ...
      public Set<Material> getTerritoryDenyUsageMaterials() {
        if (territoryDenyUsageMaterialsMat == null) {
          ...
          territoryDenyUsageMaterials
            .forEach(m -> territoryDenyUsageMaterialsMat.add(Material.getMaterial(m)));
      ...
      public Set<Material> getTerritoryDenyUsageMaterialsWhenOffline() {
        if (territoryDenyUsageMaterialsWhenOfflineMat == null) {
          ...
          territoryDenyUsageMaterialsWhenOffline
            .forEach(m -> territoryDenyUsageMaterialsWhenOfflineMat.add(Material.getMaterial(m)));
          territoryDenyUsageMaterialsWhenOfflineMat.remove(Material.AIR);
          territoryDenyUsageMaterialsWhenOfflineMat =
            Collections.unmodifiableSet(territoryDenyUsageMaterialsWhenOfflineMat);
        }
      ...
      public Set<Material> getContainerExceptions() {
        if (containerExceptionsMat == null) {
          ...
          containerExceptions.forEach(m -> containerExceptionsMat.add(Material.getMaterial(m)));
      ...
      public Set<Material> getBreakExceptions() {
        if (breakExceptionsMat == null) {
          ...
          breakExceptions.forEach(m -> breakExceptionsMat.add(Material.getMaterial(m)));
      ...
      public Set<String> getPlayersWhoBypassAllProtection() {
        return playersWhoBypassAllProtection == null ? Collections.emptySet() :
               Collections.unmodifiableSet(playersWhoBypassAllProtection);
      }

      public Set<String> getWorldsNoWildernessProtection() {
        return worldsNoWildernessProtection == null ? Collections.emptySet() :
               Collections.unmodifiableSet(worldsNoWildernessProtection);
      }
    ...
    public class Spawning {
      ...
      public Set<CreatureSpawnEvent.SpawnReason> getPreventInSafezone() {
        if (preventSpawningInSafezoneReason == null) {
          preventSpawningInSafezoneReason =
            MiscUtil.typeSetFromStringSet(preventSpawningInSafezone, MiscUtil.SPAWN_REASON_FUNCTION);
        }
      ...
      public Set<EntityType> getPreventInSafezoneExceptions() {
        if (preventSpawningInSafezoneExceptionsType == null) {
          preventSpawningInSafezoneExceptionsType =
            MiscUtil.typeSetFromStringSet(preventSpawningInSafezoneExceptions, MiscUtil.ENTITY_TYPE_FUNCTION);
        }
      ...
      public Set<CreatureSpawnEvent.SpawnReason> getPreventInTerritory() {
        if (preventSpawningInTerritoryReason == null) {
          preventSpawningInTerritoryReason =
            MiscUtil.typeSetFromStringSet(preventSpawningInTerritory, MiscUtil.SPAWN_REASON_FUNCTION);
        }
      ...
      public Set<EntityType> getPreventInTerritoryExceptions() {
        if (preventSpawningInTerritoryExceptionsType == null) {
          preventSpawningInTerritoryExceptionsType = MiscUtil
            .typeSetFromStringSet(preventSpawningInTerritoryExceptions, MiscUtil.ENTITY_TYPE_FUNCTION);
        }
      ...
      public Set<CreatureSpawnEvent.SpawnReason> getPreventInWarzone() {
        if (preventSpawningInWarzoneReason == null) {
          preventSpawningInWarzoneReason =
            MiscUtil.typeSetFromStringSet(preventSpawningInWarzone, MiscUtil.SPAWN_REASON_FUNCTION);
        }
      ...
      public Set<EntityType> getPreventInWarzoneExceptions() {
        if (preventSpawningInWarzoneExceptionsType == null) {
          preventSpawningInWarzoneExceptionsType =
            MiscUtil.typeSetFromStringSet(preventSpawningInWarzoneExceptions, MiscUtil.ENTITY_TYPE_FUNCTION);
        }
      ...
      public Set<CreatureSpawnEvent.SpawnReason> getPreventInWilderness() {
        if (preventSpawningInWildernessReason == null) {
          preventSpawningInWildernessReason =
            MiscUtil.typeSetFromStringSet(preventSpawningInWilderness, MiscUtil.SPAWN_REASON_FUNCTION);
        }
      ...
      public Set<EntityType> getPreventInWildernessExceptions() {
        if (preventSpawningInWildernessExceptionsType == null) {
          preventSpawningInWildernessExceptionsType = MiscUtil
            .typeSetFromStringSet(preventSpawningInWildernessExceptions, MiscUtil.ENTITY_TYPE_FUNCTION);
        }
    ...
    public class Other {
      ...
      @Comment("When faction membership hits this limit, players will no longer be able to join using /f " +
               "join; default is 0, no limit")
      private int factionMemberLimit = 0;

      @Comment("What faction ID to start new players in when they first join the server; default is 0, \"no" +
               " faction\"")
      ...
      // 1 server tick is roughly 50ms, so default max 10% of a tick
      ...
      public List<String> getNameBlacklist() {
        return nameBlacklist == null ? Collections.emptyList() :
               Collections.unmodifiableList(this.nameBlacklist);
      }
  ...
  public class Economy {
    ...
    @Comment("This setting matters in particular if you have per-world economy.\n" +
             ...
             "Note that you should set up your per-world plugin to treat all your Factions worlds as one " +
             "group/world.")
    ...
    @Comment("Faction banks, to pay for land claiming and other costs instead of individuals paying for " +
             "them\n" +
             "This IS NOT the setting for enabling economy features overall. That setting is just named " +
             "\"enabled\"")
  ...
  public class RestrictWorlds {
    ...
    @Comment("If restrictWorlds is true, this setting determines if the world list below is a whitelist or " +
             "blacklist.\n" +
  ...
  public class WorldBorder {
    ...
    @Comment("WorldBorder support\n" +
             "This is for Minecraft's built-in command. To get your current border: /minecraft:worldborder " +
             "get\n" +
