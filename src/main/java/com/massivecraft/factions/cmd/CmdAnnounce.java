...
public class CmdAnnounce extends FCommand {
  ...
  public CmdAnnounce() {
    ...
    this.requirements =
        new CommandRequirements.Builder(Permission.ANNOUNCE).memberOnly().withRole(Role.MODERATOR)
            .noErrorOnManyArgs()
            .noDisableOnLock()
  ...
  public void perform(CommandContext context) {
    String prefix =
        ChatColor.GREEN + context.faction.getTag() + ChatColor.YELLOW + " [" + ChatColor.GRAY + context.player
            .getName() + ChatColor.YELLOW + "] " + ChatColor.RESET;
