...
public class CmdTop extends FCommand {
  ...
  public void perform(CommandContext context) {
    ...
    } else if (FactionsPlugin.getInstance().getLandRaidControl() instanceof PowerControl && criteria
    ...
    } else if (criteria.equalsIgnoreCase("money") || criteria.equalsIgnoreCase("balance") || criteria
      .equalsIgnoreCase("bal")) {
      factionList.sort((f1, f2) -> {
    ...
    for (Faction faction : factionList.subList(start, end)) {
      ...
      String fac = context.sender instanceof Player ?
                   faction.getRelationTo(context.fPlayer).getColor() + faction.getTag() : faction.getTag();
