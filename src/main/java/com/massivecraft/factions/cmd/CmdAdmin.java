...
public class CmdAdmin extends FCommand {
  ...
  public void perform(CommandContext context) {
    ...
    if (fyou.getFaction() != targetFaction) {
      FPlayerJoinEvent event =
        new FPlayerJoinEvent(FPlayers.getInstance().getByPlayer(context.player), targetFaction,
                             FPlayerJoinEvent.PlayerJoinReason.LEADER);
    ...
    if (fyou == admin) {
      ...
      fyou.msg(TL.COMMAND_ADMIN_DEMOTED, context.player == null ? TL.GENERIC_SERVERADMIN.toString() :
                                         context.fPlayer.describeTo(fyou, true));
      return;
    }
    ...
    for (FPlayer fplayer : FPlayers.getInstance().getOnlinePlayers()) {
      fplayer.msg(TL.COMMAND_ADMIN_PROMOTED, context.player == null ? TL.GENERIC_SERVERADMIN.toString() :
                                             context.fPlayer.describeTo(fplayer, true),
