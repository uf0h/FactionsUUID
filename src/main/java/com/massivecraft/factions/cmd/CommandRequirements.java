...
public class CommandRequirements {
  ...
  private CommandRequirements(Permission permission, boolean playerOnly, boolean memberOnly, Role role,
  ...
  public static class Builder {
    ...
    public CommandRequirements build() {
      CommandRequirements requirements =
        new CommandRequirements(permission, playerOnly, memberOnly, role, action);
