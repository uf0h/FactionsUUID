...
public class MyLocationTypeAdapter implements JsonDeserializer<LazyLocation>, JsonSerializer<LazyLocation> {
  ...
  @Override
  public LazyLocation deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
    ...
    try {
      ...
      FactionsPlugin.getInstance().getLogger()
        .log(Level.SEVERE, "Error encountered while deserializing a LazyLocation.", ex);
      return null;
    }
  }
  ...
  public JsonElement serialize(LazyLocation src, Type typeOfSrc, JsonSerializationContext context) {
    ...
    try {
      ...
      FactionsPlugin.getInstance().getLogger()
        .log(Level.SEVERE, "Error encountered while serializing a LazyLocation.", ex);
      return obj;
    }
  }
