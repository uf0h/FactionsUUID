...
public class MapFLocToStringSetTypeAdapter implements JsonDeserializer<Map<FLocation, Set<String>>>,
  ...
  @Override
  public Map<FLocation, Set<String>> deserialize(JsonElement json, Type typeOfT,
    ...
    try {
      ...
      FactionsPlugin.getInstance().getLogger()
          .log(Level.SEVERE, "Error encountered while deserializing a Map of FLocations to String Sets.", ex);
      return null;
    }
  }

  @Override
  public JsonElement serialize(Map<FLocation, Set<String>> src, Type typeOfSrc,
    ...
    try {
      ...
      FactionsPlugin.getInstance().getLogger()
          .log(Level.SEVERE, "Error encountered while serializing a Map of FLocations to String Sets.", ex);
      return obj;
    }
  }
