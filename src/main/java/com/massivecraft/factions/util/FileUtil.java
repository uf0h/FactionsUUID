...
public final class FileUtil {
  ...
  public static void saveResource(final ClassLoader classLoader, final String dataFolder, String resourcePath,
    ...
    try {
      if (!outFile.exists() || replace) {
        ...
        FactionsPlugin.getInstance().getLogger().log(Level.WARNING, "Could not save " + outFile
          .getName() + " to " + outFile + " because " + outFile.getName() + " already exists.");
      }
    } catch (final IOException ex) {
      FactionsPlugin.getInstance().getLogger()
        .log(Level.SEVERE, "Could not save " + outFile.getName() + " to " + outFile, ex);
    }
  }
