...
// TODO: Give better name and place to differentiate from the entity-orm-ish system in "com.massivecraft
//  .core.persist".
...
public class Persist {
  ...
  public <T> T load(Class<T> clazz, File file) {
    ...
    } catch (Exception ex) {    // output the error message rather than full stack trace; error parsing the
      // file, most likely
